...
> All Claude Code workflows — orchestration patterns, agent chains, cross-model pipelines, skill invocations, and production-ready workflow templates.
...
|---|---|---|
| [Workflows Core](bin/) | `bin/` | Primary automation scripts and tools for claude-ai-workflows |
